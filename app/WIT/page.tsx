  ...
  return (
    <>
      <Box bg={useColorModeValue('white', 'gray.700')}>
        ...
        <Stack bg={useColorModeValue('white', 'gray.700')} minH={'50vh'} direction={{ base: 'column', md: 'row' }}>
        ...
        <Container bg={useColorModeValue('white', 'gray.700')} maxW={'7xl'}>
          <Stack
            as={Box}
            textAlign={'center'}
            ...
            <Text color={useColorModeValue('gray.500', 'gray.300')} fontSize={{ base: 'md', lg: 'lg' }} >
