...
export default function HomeHero() {
    return (
        <Box backgroundImage={useColorModeValue("BackHero.jpg","BackHeroblack.jpg")} overflow={"hidden"} backgroundSize={"cover"} >
            <Box w='100%' px={"20px"} >
                <Stack direction={{base:"column", lg:"row"}} alignItems={"center"}>
                    <Box w={{ base: "100%", lg: "60%" }} textColor={"black"} py={"50px"}>
                        ...
                        <Heading color={useColorModeValue("black","white")} fontSize={"45px"} fontWeight={"medium"}>
                            for Artificial Intelligence and Computing
                        </Heading>
                        <Text color={useColorModeValue("black","white")} lineHeight={"5"} my={"15px"} fontSize={"17px"}>
