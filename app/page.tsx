...
import { Box, Button, Card, CardBody,useColorModeValue, CardFooter, CardHeader, Heading, SimpleGrid, chakra } from '@chakra-ui/react'
      ...
      <Box  bg={useColorModeValue('white', 'gray.700')}>
        ...
        <Box
          ...
          <SimpleGrid columns={[1, 2, 4]} spacing='40px'>
            <Card bg={useColorModeValue('white', 'gray.500')} boxShadow={"2xl"} variant={'elevated'}>
              <CardHeader>
